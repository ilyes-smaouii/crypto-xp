...
struct XXTEABlockAlgo {
  using key_t = EncryptionKey<128>;

private:
  static constexpr std::uint32_t DELTA = 0 /* 0x9E3779B9 */;
  static constexpr std::uint32_t INITIAL_SUM_DECRYPTION = 0 /* 0xC6EF3720 */;

public:
  key_t _key{};

  XXTEABlockAlgo() = default;
  XXTEABlockAlgo(const key_t &ec_key);
